...
class User extends CI_Controller
{
    ...
    private function _validasi($mode)
    {
        ...
        if ($mode == 'add') {
            $this->form_validation->set_rules('no_induk', 'NIM/NIP', 'required|trim|is_unique[user.no_induk]|alpha_numeric');
            ...
            $nim = $this->input->post('no_induk', true);

            $uniq_username = $db['username'] == $username ? '' : '|is_unique[user.username]';
            $uniq_email = $db['email'] == $email ? '' : '|is_unique[user.email]';
            $uniq_nim = $db['no_induk'] == $nim ? '' : '|is_unique[user.no_induk]';

            $this->form_validation->set_rules('no_induk', 'NIM/NIP', 'required|trim|alpha_numeric' . $uniq_nim);
