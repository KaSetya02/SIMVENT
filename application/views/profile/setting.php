    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <hr>
                <div class="row form-group">
                    <label class="col-md-3 text-md-left" for="username">Username</label>
                    <div class="col-md-9">
                ...
                <hr>
                <div class="row form-group">
                    <label class="col-md-3 text-md-left" for="nama">Nama Anda</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-left" for="email">Email</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
