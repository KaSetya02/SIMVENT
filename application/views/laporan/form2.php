                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                      <!--   <div class="custom-control custom-radio">
                        ...
                        <div class="custom-control custom-radio">
                            <input value="hapus" type="radio" id="hapus" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="hapus"> Data Pengajuan Penghapusan Aset</label>
                        </div>
