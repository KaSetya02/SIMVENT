    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <hr>
                 <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="no_induk">NIM/NIP</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('no_induk', $user['no_induk']); ?>" type="text" id="no_induk" name="no_induk" class="form-control" placeholder="NIM/NIP" readonly>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'akademik' ? 'checked' : ''; ?> <?= set_radio('role', 'akademik'); ?> value="akademik" type="radio" id="akademik" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="akademik">Akademik</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'prodi' ? 'checked' : ''; ?> <?= set_radio('role', 'prodi'); ?> value="prodi" type="radio" id="prodi" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="prodi">Prodi</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'mahasiswa' ? 'checked' : ''; ?> <?= set_radio('role', 'mahasiswa'); ?> value="mahasiswa" type="radio" id="mahasiswa" name="role" class="custom-control-input">
