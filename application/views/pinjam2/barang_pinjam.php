        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?php echo base_url('pinjam2'); ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                <?= $this->session->flashdata('pesan'); ?>
                	<?= form_open_multipart('pinjam2/barang_pinjam_act'); ?>
             <!--   <form class="form-horizontal" method="POST" id="barang_pinjam" action="<?php echo base_url('pinjam2/barang_pinjam_act'); ?>"> -->
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-left" for="id_aset">Kode Aset</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-barcode"></i></span>
                            </div>
                            <input type="text" class="form-control" value="<?php echo $data->id_aset; ?>" disabled>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $data->nama_aset; ?>" disabled>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
